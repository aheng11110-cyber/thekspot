...
export function NewsSidebar() {
  ...
  return (
    <>
      <div className="hidden xl:flex absolute top-24 right-4 bottom-6 w-[clamp(200px,22vw,320px)] bg-black/50 backdrop-blur-xl border-2 border-white/30 rounded-2xl z-30 flex-col p-4 lg:p-6 shadow-2xl">
