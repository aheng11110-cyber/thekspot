...
export const SITE_CONTENT = {
  EN: {
    ...
    pricing: {
      ...
      free: 'Free',
      freeDesc: 'Weekly K-Trend News highlights delivered straight to your inbox.',
      freeFeatures: ['Weekly trend highlights', 'Basic K-pop & Culture news', 'Community access'],
      basic: 'Basic',
      pro: 'Pro',
    ...
    hashtag: {
      ...
      categories: ['All', 'Popup', 'Cafe', 'Food', 'Culture', 'Beauty', 'K-Pop'],
      tags: [
        { cat: 'Popup', tag: '#성수팝업', meaning: '#SeongsuPopup' },
        { cat: 'Popup', tag: '#더현대서울팝업', meaning: '#TheHyundaiSeoulPopup' },
        { cat: 'Popup', tag: '#뷰티팝업', meaning: '#BeautyPopup' },
  ...
  KO: {
    ...
    technology: {
      ...
      features: [
        ...
        { title: '실시간 해시태그', desc: "지루한 교과서 언어는 그만. 한국인들이 커뮤니티에서 쓰는 진짜 밈을 알려드립니다." },
    ...
    pricing: {
      ...
      free: '무료',
      freeDesc: '매주 K-트렌드 하이라이트를 이메일로 받아보세요.',
      freeFeatures: ['주간 트렌드 하이라이트', '기본 K-pop 및 문화 소식', '커뮤니티 접근 권한'],
      basic: '베이직',
      pro: '프로',
      enterprise: '엔터프라이즈',
      mostPopular: '가장 인기있는',
    ...
    hashtag: {
      ...
      categories: ['전체', '팝업', '카페', '맛집', '문화', '뷰티', 'K-Pop'],
      tags: [
        { cat: '팝업', tag: '#성수팝업', meaning: '#SeongsuPopup' },
        { cat: '팝업', tag: '#더현대서울팝업', meaning: '#TheHyundaiSeoulPopup' },
        { cat: '팝업', tag: '#뷰티팝업', meaning: '#BeautyPopup' },
        { cat: '팝업', tag: '#패션팝업', meaning: '#FashionPopup' },
        { cat: '팝업', tag: '#캐릭터팝업', meaning: '#CharacterPopup' },
        { cat: '팝업', tag: '#식음료팝업', meaning: '#FandBPopup' },
        { cat: '팝업', tag: '#체험형팝업', meaning: '#ExperiencePopup' },
        { cat: '팝업', tag: '#팝업스토어', meaning: '#PopupStore' },
        { cat: '카페', tag: '#성수동카페', meaning: '#SeongsuCafe' },
        { cat: '카페', tag: '#연남동카페', meaning: '#YeonnamCafe' },
        { cat: '카페', tag: '#에스프레소바', meaning: '#EspressoBar' },
        { cat: '카페', tag: '#베이커리카페', meaning: '#BakeryCafe' },
        { cat: '카페', tag: '#루프탑카페', meaning: '#RooftopCafe' },
        { cat: '카페', tag: '#한옥카페', meaning: '#HanokCafe' },
        { cat: '카페', tag: '#디저트맛집', meaning: '#DessertCafe' },
        { cat: '카페', tag: '#대형카페', meaning: '#LargeCafe' },
        { cat: '카페', tag: '#비건카페', meaning: '#VeganCafe' },
        { cat: '맛집', tag: '#성수맛집', meaning: '#SeongsuFood' },
        { cat: '맛집', tag: '#홍대맛집', meaning: '#HongdaeFood' },
        { cat: '맛집', tag: '#압구정로데오맛집', meaning: '#ApgujeongRodeoFood' },
        { cat: '맛집', tag: '#을지로맛집', meaning: '#EuljiroFood' },
        { cat: '맛집', tag: '#오마카세', meaning: '#Omakase' },
        { cat: '맛집', tag: '#파인다이닝', meaning: '#FineDining' },
        { cat: '맛집', tag: '#KBBQ', meaning: '#KoreanBBQ' },
        { cat: '맛집', tag: '#삼겹살맛집', meaning: '#Samgyeopsal' },
        { cat: '맛집', tag: '#평양냉면', meaning: '#PyeongyangNaengmyeon' },
        { cat: '맛집', tag: '#로컬노포', meaning: '#LocalOldEatery' },
        { cat: '맛집', tag: '#국밥맛집', meaning: '#Gukbap' },
        { cat: '맛집', tag: '#길거리음식', meaning: '#StreetFood' },
        { cat: '맛집', tag: '#분식맛집', meaning: '#Bunsik' },
        { cat: '문화', tag: '#서울전시회', meaning: '#SeoulExhibition' },
        { cat: '문화', tag: '#미디어아트', meaning: '#MediaArt' },
        { cat: '문화', tag: '#원데이클래스', meaning: '#OneDayClass' },
        { cat: '문화', tag: '#경복궁야간개장', meaning: '#GyeongbokgungNight' },
        { cat: '문화', tag: '#고궁투어', meaning: '#PalaceTour' },
        { cat: '문화', tag: '#북촌한옥마을', meaning: '#BukchonHanokVillage' },
        { cat: '문화', tag: '#템플스테이', meaning: '#TempleStay' },
        { cat: '문화', tag: '#사찰여행', meaning: '#TempleTour' },
        { cat: '문화', tag: '#전통시장', meaning: '#TraditionalMarket' },
        { cat: '문화', tag: '#광장시장', meaning: '#GwangjangMarket' },
        { cat: '문화', tag: '#박물관투어', meaning: '#MuseumTour' },
        { cat: '문화', tag: '#K드라마촬영지', meaning: '#KDramaLocation' },
        { cat: '문화', tag: '#한강공원', meaning: '#HangangPark' },
        { cat: '문화', tag: '#피크닉', meaning: '#Picnic' },
        { cat: '뷰티', tag: '#올리브영추천템', meaning: '#OliveYoungMustHave' },
        { cat: '뷰티', tag: '#퍼스널컬러진단', meaning: '#PersonalColor' },
        { cat: '뷰티', tag: '#K뷰티', meaning: '#KBeauty' },
        { cat: '뷰티', tag: '#플래그십스토어', meaning: '#FlagshipStore' },
        { cat: '뷰티', tag: '#디자이너브랜드', meaning: '#DesignerBrand' },
        { cat: 'K-Pop', tag: '#아이돌생일카페', meaning: '#IdolBirthdayCafe' },
        { cat: 'K-Pop', tag: '#성지순례', meaning: '#KpopPilgrimage' },
        { cat: 'K-Pop', tag: '#사옥투어', meaning: '#AgencyTour' },
        { cat: 'K-Pop', tag: '#음악방송', meaning: '#MusicShow' }
  ...
  JP: {
    ...
    pricing: {
      ...
      free: '無料',
      freeDesc: '毎週K-トレンドのハイライトをメールでお届けします。',
      freeFeatures: ['週刊トレンドハイライト', '基本K-pop・文化ニュース', 'コミュニティアクセス'],
      basic: 'ベーシック',
      pro: 'プロ',
      enterprise: 'エンタープライズ',
      mostPopular: '一番人気',
    ...
    hashtag: {
      ...
      tags: [
        ...
        { cat: 'カフェ', tag: '#성수동카페', meaning: '#SeongsuCafe' },
        { cat: 'カフェ', tag: '#홍대카페' },
        { cat: 'グルメ', tag: '#성수맛집', meaning: '#SeongsuFood' },
        { cat: 'グルメ', tag: '#홍대맛집', meaning: '#HongdaeFood' },
        { cat: '文化', tag: '#전시회추천' },
        { cat: '文化', tag: '#서울데이트' },
      ]
    }
  ...
  CN: {
    ...
    pricing: {
      ...
      free: '免费',
      freeDesc: '每周将韩国趋势亮点直接发送到您的邮箱。',
      freeFeatures: ['每周趋势亮点', '基本K-pop与文化新闻', '社区访问权限'],
      basic: '基础版',
      pro: '专业版',
      enterprise: '企业版',
      mostPopular: '最受欢迎',
    ...
    hashtag: {
      ...
      tags: [
        ...
        { cat: '快闪店', tag: '#더현대서울' },
        { cat: '咖啡店', tag: '#성수동카페', meaning: '#SeongsuCafe' },
        { cat: '咖啡店', tag: '#홍대카페' },
        { cat: '美食', tag: '#성수맛집', meaning: '#SeongsuFood' },
        { cat: '美食', tag: '#홍대맛집', meaning: '#HongdaeFood' },
        { cat: '文化', tag: '#전시회추천' },
        { cat: '文化', tag: '#서울데이트' },
      ]
    }
  ...
  VN: {
    ...
    pricing: {
      ...
      free: 'Miễn phí',
      freeDesc: 'Nhận bản tin nổi bật về xu hướng K-Trend hàng tuần qua email.',
      freeFeatures: ['Điểm nổi bật xu hướng hàng tuần', 'Tin tức K-pop & văn hóa cơ bản', 'Quyền truy cập cộng đồng'],
      basic: 'Cơ Bản',
      pro: 'Chuyên Nghiệp',
    ...
    hashtag: {
      ...
      tags: [
        ...
        { cat: 'Cafe', tag: '#성수동카페', meaning: '#SeongsuCafe' },
        { cat: 'Cafe', tag: '#홍대카페' },
        { cat: 'Ẩm thực', tag: '#성수맛집', meaning: '#SeongsuFood' },
        { cat: 'Ẩm thực', tag: '#홍대맛집', meaning: '#HongdaeFood' },
